...
@Path("/datastoreget")
public class datastorewebservice {
    ...
    public Response add(String incomingData/*,@FormParam("file") InputStream uploadedInputStream,
    		@FormParam("file") FormDataContentDisposition fileDetail*/) throws IOException
     {
		...
		try {
			...
			AddProperty addproperty=new AddProperty();
			//String filename= message.id +fileDetail.getFileName();
			//String uploadedFileLocation = "/media/anirban/D/" + filename;

			// save it
		//	writeToFile(uploadedInputStream, uploadedFileLocation);

		//	String output = "File uploaded to : " + uploadedFileLocation;
		//	System.out.println("output::"+uploadedFileLocation);
		...
		/*	AddImage image_det = mapper.readValue(incomingData, AddImage.class);
			...
			image_details.setImage_url(uploadedFileLocation);
