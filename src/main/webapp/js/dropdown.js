...
function initSelectors(){
 ...
 MAIN.createRelatedSelector(); 
 MAIN.createRelatedSelector(document.querySelector('#house_category') );
 
 //countries
 MAIN.createRelatedSelector
     ( document.querySelector('#house_category')           // from select element
      ,document.querySelector('#house_type')      // to select element
      ,{                                            // values object 
        Commercial: ['Healthcare','Industrial','Leisure','Multifamily','Office','Retail'],
        Land: ['Commercial/Other Land','Industrial Land','Leased land','Multifamily land','Office Land','Retail Land','Retail-pad Land'],
        Resident: ['Apartment','Condo','Farm/Lanch','Income/Investment','Loft','Multi-family Home','Single-family Home','Townhouse','Others']
      }
